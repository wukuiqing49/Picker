...
import com.cnlive.media.databinding.ActivityMediaBinding;
import com.cnlive.media.frame.presenter.MediaPresenter;
import com.cnlive.media.frame.view.MediaView;
import com.cnlive.media.media.DataCallback;
import com.cnlive.media.media.entity.Folder;
import com.cnlive.media.media.entity.Media;
import com.cnlive.media.media.loader.ImageLoader;
import com.cnlive.media.media.loader.LoaderM;
import com.cnlive.media.media.loader.MediaLoader;
import com.cnlive.media.media.loader.VideoLoader;
import com.cnlive.media.model.ImagePickerCropParams;
import com.cnlive.media.model.ImagePickerOptions;
import com.cnlive.media.ui.adapter.FolderAdapter;
import com.cnlive.media.ui.fragment.MediaPickerFragment;
import com.cnlive.media.ui.fragment.MediaPreviewFragment;
import com.cnlive.media.utils.observable.MediaAddObservable;
import com.cnlive.media.utils.observable.MediaOpenActivityObservable;
import com.cnlive.media.utils.observable.MediaOpenInfo;
import com.cnlive.media.utils.observable.MediaPageSelectStateObservable;
import com.cnlive.media.utils.observable.MediaSelectStateObservable;
...
import static com.cnlive.media.PickerConfig.REQUEST_CODE_PERMISSION_CAMERA;
import static com.cnlive.media.PickerConfig.REQUEST_CODE_PERMISSION_CROP;
import static com.cnlive.media.PickerConfig.REQUEST_CODE_PERMISSION_READ;
...
public class MediaActivity extends MvpBindingActivity<MediaView, MediaPresenter, ActivityMediaBinding> implements DataCallback, Observer, View.OnClickListener {
    ...
    public List<Folder> getMediasLists() {
        return mediasList;
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CODE_PERMISSION_CAMERA) {
            if (hasPermissions[0]) {
                ...
                getMvpView().showPermission(permissionsRecord, PickerConfig.REQUEST_CODE_PERMISSION_CAMERA, this.getResources().getString(R.string.dialog_imagepicker_permission_camera_nerver_ask_message), false);
            }
            ...
            if (hasPermissions[0]) {
                ...
                getMvpView().showPermission(permissionsRecord, PickerConfig.REQUEST_CODE_PERMISSION_READ, this.getResources().getString(R.string.dialog_imagepicker_permission_sdcard_nerver_ask_message), true);
            }
            ...
            if (hasPermissions[0]) {
                ...
                getMvpView().showPermission(permissionsRecord, PickerConfig.REQUEST_CODE_PERMISSION_READ, this.getResources().getString(R.string.dialog_imagepicker_permission_sdcard_nerver_ask_message), false);
            }
        }
