...
import com.cnlive.media.ui.fragment.RecordFragment;
...
public class RecordView implements MvpView {
    ...
    public void checkPermisssion() {
        ...
        if (hasPermissions) {
            mActivity.getSupportFragmentManager().beginTransaction().replace(R.id.pre_frame, RecordFragment.newInstance()).addToBackStack("").commit();
        }
